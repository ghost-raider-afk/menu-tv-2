...
export const ROUTE_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({ path: '/playlist.html', page: 'animation', section: 'playlist', title: 'Плейлист', prefetch: true }),
...
const CONTEXT_LINKS = Object.freeze({
  ...
  playlist: Object.freeze([['Плейлист', '/playlist.html']]),
...
export const PRIMARY_ROUTES = Object.freeze([
  ...
  Object.freeze({ key: 'playlist', label: 'Плейлист', href: '/playlist.html', icon: 'motion' }),
