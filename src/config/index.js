...
export function loadConfig(env = process.env) {
  ...
  return Object.freeze({
    ...
    frontendErrorRetentionDays: integer('FRONTEND_ERROR_RETENTION_DAYS', env.FRONTEND_ERROR_RETENTION_DAYS, { minimum: 1, maximum: 365 }),
    frontendErrorMaxEntries: integer('FRONTEND_ERROR_MAX_ENTRIES', env.FRONTEND_ERROR_MAX_ENTRIES, { minimum: 100, maximum: 100000 }),
    passwordMinLength,
    passwordMaxLength,
