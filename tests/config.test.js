...
function validEnv(overrides = {}) {
  return {
    ...
    JSON_BODY_MAX_BYTES: '65536', CATALOG_CSV_MAX_BYTES: '5242880', MENU_DRAFT_MAX_BYTES: '49152', SCREEN_SOURCE_MAX_BYTES: '12582912',
...
test('runtime limits are controlled only by environment values', () => {
  const config = loadConfig(validEnv({
    JSON_BODY_MAX_BYTES: '70000', CATALOG_CSV_MAX_BYTES: '6000000', MENU_DRAFT_MAX_BYTES: '50000', SCREEN_SOURCE_MAX_BYTES: '13000000', SCREEN_BACKGROUND_MAX_BYTES: '20000000',
  ...
  assert.equal(config.catalogCsvMaxBytes, 6000000);
