...
function validEnv(overrides = {}) {
  return {
    ...
    SITE_ASSETS_ROOT: '/tmp/menu-tv-site-assets', SITE_LOGO_MAX_BYTES: '2097152', SITE_FAVICON_MAX_BYTES: '524288', SCREEN_BACKGROUND_MAX_BYTES: '20971520', ANIMATION_ENTITY_MAX_BYTES: '20971520',
...
test('runtime limits are controlled only by environment values', () => {
  const config = loadConfig(validEnv({
    JSON_BODY_MAX_BYTES: '70000', MENU_DRAFT_MAX_BYTES: '50000', SCREEN_SOURCE_MAX_BYTES: '13000000', SCREEN_BACKGROUND_MAX_BYTES: '20000000', ANIMATION_ENTITY_MAX_BYTES: '33000000',
  ...
  assert.equal(config.animationEntityMaxBytes, 33000000);
